...
solution = cutting_cloth(X,Y,a,b,p)

print(solution)

k = len(p)
solution_teacher = [None]*k
for i in range(0, k):
	sum_ = 0
	for item in solution[1]:
		if item == i: sum_ = sum_ + 1
	solution_teacher[i] = sum_
print(solution_teacher)
...
#print(cutting_cloth(15,20, [3,5,6], [10,7,5], [35,40,45]))